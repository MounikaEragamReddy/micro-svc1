    ...
    stages {
        stage('Docker build') {
            steps {
                sh '''
                #docker build
                docker build -t 496501836491.dkr.ecr.ap-southeast-1.amazonaws.com/static-apache:$BUILD_NUMBER .
                #login to ecr
                ...
                docker push 496501836491.dkr.ecr.ap-southeast-1.amazonaws.com/static-apache:$BUILD_NUMBER
                '''
            }
        }
        stage('EKS deploy') {
